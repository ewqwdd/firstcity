    ...
    <main>
        <HStack as='header' className={cn("relative h-96 w-full after:bg-slate-800", styles.hero)}>
            ...
            <VStack className="text-white gap-[14px] self-center w-full max-w-7xl mx-auto px-3">
                <Heading className="capitalize text-[40px] text-white font-medium" as='h1'>
                    About <b>First City</b>
                </Heading>
                <p className="lg:text-xl text-base max-w-[710px]">
        ...
        <VStack as='section' className="my-20 max-w-7xl px-3 lg:flex-row gap-[5%] mx-auto">
            <VStack className="lg:min-w-[560px] lg:w-[50%]">
                <span className="text-secondary uppercase tracking-[10%] text-xl">
                    About us
                </span>
                <VStack className="[&>h2]:capitalize [&>h2]:text-4xl [&>h2]:text-slate-800 [&>h2]:font-medium [&>h2]:mb-3 [&>h2]:mt-7 gap-2" dangerouslySetInnerHTML={{
                    __html: raw
                }} />
            </VStack>
