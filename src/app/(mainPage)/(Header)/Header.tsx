    ...
    <HStack className={'bg-FMC_primary'} as="header" id="header">
      <div className={cn(styles.heading, 'max-w-7xl mx-auto gap-2')}>
        ...
        <VStack className="m-auto gap-0 lg:gap-6 lg:max-w-[570px] lg:ml-0 max-lg:px-3 max-lg:items-center max-lg:my-0">
          <Paragraph
            fontFamily="Salsa"
            className="text-slate-400 text-xl max-lg:order-2"
          >
          ...
          <Paragraph className="text-slate-300 max-lg:order-4 max-[420px]:px-0 max-lg:max-w-3xl max-[520px]:px-3 max-lg:px-6 max-lg:mt-6">
            ...
            laborum elit do fugiat consectetur dolor excepteur aute. Qui eu nisi
            eu mollit nulla nisi magna do voluptate non dolor enim non. Veniam
            ex duis fugiat magna. Ut dolore anim elit dolor velit. Consectetur
            aliqua ipsum cupidatat commodo Lorem.
          </Paragraph>
          <HStack className="lg:gap-4 max-lg:justify-between max-lg:self-stretch max-lg:px-3 max-[420px]:px-0 text-slate-200 max-lg:order-3 max-lg:mt-5">
            <Button
              asChild
              variant={'secondary'}
              className="text-white font-medium text-lg max-[420px]:px-6 max-[360px]:px-4 max-[310px]:px-2"
              size={'lg'}
            >
            ...
            <Button
              variant={'ghost'}
              className="text-lg hover:bg-slate-100/10 hover:text-slate-50 max-[420px]:px-6 max-[360px]:px-4 max-[310px]:px-2"
              size={'lg'}
            >
              How it works?
            </Button>
